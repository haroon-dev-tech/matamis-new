 ...
 * @var array $totals from calculate_linked_is_totals
 * @var bool $editable
 */
$editable = $editable ?? true;
$totals = $totals ?? calculate_linked_is_totals($structure, $values);
?>

<div class="overflow-x-auto">
    <table class="w-full text-sm" id="linked-is-table">
        <thead>
        ...
        <?php foreach ($structure['heads'] as $head): ?>
            <tr class="somfp-row-section">
                ...
                <td class="px-4 py-3 text-right font-mono font-semibold linked-is-head-total" data-head-id="<?= $head['id'] ?>">
            ...
            <tr>
                ...
                <td class="px-4 py-2">
                    ...
                    <input type="text"
                           name="items[<?= $item['id'] ?>]"
                           class="money-input input-field linked-is-item-input"
        ...
        <?php endforeach; ?>
            ...
            <tr class="somci-row-final">
                ...
                <td class="px-4 py-3 text-right font-mono font-bold" id="linked-is-net-profit">
                    <?= format_money($totals['net_profit_loss']) ?>
                </td>
            </tr>
        </tbody>
    </table>
